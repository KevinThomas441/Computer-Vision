img1 = imread('guitar.jpg');
img1 = im2double(img1);
img1 = rgb2gray(img1);
[m n] = size(img1);

img2 = imread('ukulele.jpg');
img2 = im2double(img2);
img2 = rgb2gray(img2);
...
lowpassfilter = fspecial('gaussian', hs*2+1, 5);
...
lowpassfilter = fspecial('gaussian', hs*2+1, 3);
...
imwrite(hybrid_image, "guitarlele.jpg");